...
"""
Script "artisanal" mais appliqué dont le point de départ est adapté d'un modèle mis à dispo sur le Mooc Python 3
        ...
        with open(titre_semaine, encoding='utf-8') as entree:
            ...
            for line in txt_content:
                ...
                # titre 3
                    ...
                    line = titre3 + ("~" * len(titre3.strip())) + "\n\n" + ".. code:: ipython3" + "\n\n"

                # indentation de 4 espaces les lignes "bloc de code"
                else:
...
def write(txt_fullcontents):
    titre = "Corrigés"
    titre = titre + "\n" + ("=" * len(titre))
    # gestionnaire de contexte qui ouvre en écriture et ferme le fichier.rst (regroupement)
