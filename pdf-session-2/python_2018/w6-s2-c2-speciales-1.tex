...
\BuiltInTok{print}\NormalTok{(}\StringTok{'somme'}\NormalTok{, matrice1 }\OperatorTok{+}\NormalTok{ matrice2)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[frame=lines,framerule=0.6mm,rulecolor=\color{asisframecolor}]
\NormalTok{matrice2 }\OperatorTok{=}\NormalTok{ reel }\OperatorTok{*}\NormalTok{ matrice1}
\end{Highlighting}
\end{Shaded}
