...
\NormalTok{$ pip3 install numpy matplotlib pandas}
\end{Highlighting}
\end{Shaded}
...
avec \texttt{apt-get}, la méthode préconisée sera~:
    ...
    \begin{Shaded}
\begin{Highlighting}[frame=lines,framerule=0.6mm,rulecolor=\color{asisframecolor}]
\NormalTok{$ apt}\OperatorTok{-}\NormalTok{get install python3}\OperatorTok{-}\NormalTok{numpy python3}\OperatorTok{-}\NormalTok{matplotlib python3}\OperatorTok{-}\NormalTok{pandas}
\end{Highlighting}
\end{Shaded}
...
\subsubsection{Fedora}\label{fedora}}
    ...
    \begin{Shaded}
\begin{Highlighting}[frame=lines,framerule=0.6mm,rulecolor=\color{asisframecolor}]
\NormalTok{$ dnf install python3}\OperatorTok{-}\NormalTok{numpy python3}\OperatorTok{-}\NormalTok{matplotlib python3}\OperatorTok{-}\NormalTok{pandas}
\end{Highlighting}
\end{Shaded}
