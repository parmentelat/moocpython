...
\DecValTok{12} \OperatorTok{+} \DecValTok{4} \OperatorTok{*} \DecValTok{8}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[frame=lines,framerule=0.6mm,rulecolor=\color{asisframecolor}]
\DecValTok{12} \OperatorTok{+}\NormalTok{ ( }\DecValTok{4} \OperatorTok{*} \DecValTok{8}\NormalTok{ )}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[frame=lines,framerule=0.6mm,rulecolor=\color{asisframecolor}]
\NormalTok{a }\KeywordTok{and} \KeywordTok{not}\NormalTok{ b }\KeywordTok{or}\NormalTok{ c }\KeywordTok{and}\NormalTok{ d}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[frame=lines,framerule=0.6mm,rulecolor=\color{asisframecolor}]
\NormalTok{(a }\KeywordTok{and}\NormalTok{ (}\KeywordTok{not}\NormalTok{ b)) }\KeywordTok{or}\NormalTok{ (c }\KeywordTok{and}\NormalTok{ d)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[frame=lines,framerule=0.6mm,rulecolor=\color{asisframecolor}]
\NormalTok{mon_objet }\OperatorTok{=}\NormalTok{ MaClasse()}
\ControlFlowTok{if}\NormalTok{ mon_objet:}
    \OperatorTok{<}\NormalTok{faire quelque chose}\OperatorTok{>}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[frame=lines,framerule=0.6mm,rulecolor=\color{asisframecolor}]
\NormalTok{mon_objet }\OperatorTok{=}\NormalTok{ MaClasse()}
\ControlFlowTok{for}\NormalTok{ partie }\KeywordTok{in}\NormalTok{ mon_objet:}
    \OperatorTok{<}\NormalTok{faire quelque chose sur partie}\OperatorTok{>}
\end{Highlighting}
\end{Shaded}
