...
\KeywordTok{def}\NormalTok{ pgcd(a, b):}
    \CommentTok{"Le PGCD avec une fonction récursive"}
    \ControlFlowTok{if} \KeywordTok{not}\NormalTok{ b:}
        \ControlFlowTok{return}\NormalTok{ a}
    \ControlFlowTok{return}\NormalTok{ pgcd(b, a }\OperatorTok{%}\NormalTok{ b)}
\end{Highlighting}
\end{Shaded}
