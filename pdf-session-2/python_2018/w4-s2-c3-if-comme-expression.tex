...
\OperatorTok{<}\NormalTok{résultat_si_vrai}\OperatorTok{>} \ControlFlowTok{if} \OperatorTok{<}\NormalTok{condition}\OperatorTok{>} \ControlFlowTok{else} \OperatorTok{<}\NormalTok{résultat_si_faux}\OperatorTok{>}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[frame=lines,framerule=0.6mm,rulecolor=\color{asisframecolor}]
\NormalTok{valeur }\OperatorTok{=} \DecValTok{-1} \ControlFlowTok{if}\NormalTok{ x }\OperatorTok{<} \DecValTok{-10} \ControlFlowTok{else} \DecValTok{0} \ControlFlowTok{if}\NormalTok{ x }\OperatorTok{<=} \DecValTok{10} \ControlFlowTok{else} \DecValTok{1}
\end{Highlighting}
\end{Shaded}
