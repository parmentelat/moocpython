...
\CommentTok{# cette boucle ne termine pas}
\NormalTok{liste }\OperatorTok{=}\NormalTok{ [}\DecValTok{1}\NormalTok{, }\DecValTok{2}\NormalTok{, }\DecValTok{3}\NormalTok{]}
\ControlFlowTok{for}\NormalTok{ c }\KeywordTok{in}\NormalTok{ liste:}
    \ControlFlowTok{if}\NormalTok{ c }\OperatorTok{==} \DecValTok{3}\NormalTok{:}
\NormalTok{        liste.append(c)}
\end{Highlighting}
\end{Shaded}
